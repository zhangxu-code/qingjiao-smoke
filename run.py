...
FLAGS = flags.FLAGS
flags.DEFINE_string(name="args",default='{"site":"console-dev.tsingj.local","user":"smoketest","passwd":"qwer1234","key":"poc"}',help="json args")
...
def main(argv):
    ...
    suite = finder.findcases_bypath(path=os.getcwd() + '/console_api', key='poc')
